...
@section('new_button')
  <span class="new-button"><a href="{{ url('expenses/payments/create') }}" class="btn btn-success btn-sm"><span
      ...
      <div class="table table-responsive">
        <table class="table table-striped table-hover" id="tbl-payments">
          ...
          @foreach($payments as $item)
            <tr>
              <td><a
                  href="{{ url('expenses/payments/' . $item->id . '/edit') }}">{{ Date::parse($item->paid_at)->format($date_format) }}</a>
              </td>
              ...
              <td class="text-center">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="{{ url('expenses/payments/' . $item->id . '/edit') }}">{{ trans('general.edit') }}</a>
                    </li>
