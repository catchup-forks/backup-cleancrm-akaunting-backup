...
@section('new_button')
  <span class="new-button"><a href="{{ url('auth/permissions/create') }}" class="btn btn-success btn-sm"><span
              ...
              <td class="text-center">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="{{ url('auth/permissions/' . $item->id . '/edit') }}">{{ trans('general.edit') }}</a>
                    </li>
