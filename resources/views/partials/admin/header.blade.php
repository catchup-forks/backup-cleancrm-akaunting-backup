<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><img src="{{ asset('img/akaunting-logo-white.png') }}" class="logo-image-mini"
    ...
    @else
      <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><img src="{{ asset('img/akaunting-logo-green.png') }}" class="logo-image-mini"
                                 width="25" alt="Akaunting Logo"></span>
    <!-- logo for regular state and mobile devices -->
