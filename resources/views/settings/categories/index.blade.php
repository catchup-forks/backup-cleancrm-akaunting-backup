...
@section('new_button')
  <span class="new-button"><a href="{{ url('settings/categories/create') }}" class="btn btn-success btn-sm"><span
              ...
              <td class="text-center">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a
                        href="{{ url('settings/categories/' . $item->id . '/edit') }}">{{ trans('general.edit') }}</a>
                    </li>
